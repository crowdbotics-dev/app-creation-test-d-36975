...
## Project Structure
    ...
    ├── app_creation_test_d_36975  # Django project configurations
...
1. Clone this repo and `cd app_creation_test_d_36975`
...
2. Clone this repo and `cd app_creation_test_d_36975`
